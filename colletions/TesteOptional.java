...
public class TesteOptional {
	...
	public static void main(String[] args) {
		...
		Optional<String> listaString = Optional.of("Valor optional presente");// recebe valor do tipo que estamos
																				// trabalhando
		listaString.ifPresentOrElse(System.out::println, () -> System.out.println("Não está presente")); // expressão
																											// lambda
		...
		listaVazia.ifPresentOrElse(System.out::println, () -> System.out.println("Nulo - o valor não está presente"));

		Optional<String> listaComErro = Optional.of(null); // erro pois não aceita o tipo null
		listaComErro.ifPresentOrElse(System.out::println, () -> System.out.println("Erro - Não está presente")); // expressão
																													// lambda
