...
public class TesteMaps {
	...
	public static void main(String[] args) {
		...
		// buscar informa~ção atraves de uma chave e retorna um booleano
		System.out.println(quadroMedalhasOlimpicas2020.containsKey("Alemanha"));

		// buscar informa~ção atraves de um valor e retorna um booleano
		...
		quadroDeMedalhasOlimpicas2016.put("Japão", 50);
		quadroDeMedalhasOlimpicas2016.put("Grã-Bretanha", 70);
